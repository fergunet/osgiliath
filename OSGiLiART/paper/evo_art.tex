...
images comparing the histograms of a test image. Three different
...
HSV histogram, and an average of both histograms at the same
time. Results show that the HSV also increases the similarities of the
