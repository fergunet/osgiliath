...
computer, following the principle of the survival of the fittest, % pero qué es "fittest" en este contexto? - JJ
...
% Processing es mejor que alguna otra alternativa - JJ
...
of a test image. 
% Este sí podría ser el objetivo del trabajo - JJ
