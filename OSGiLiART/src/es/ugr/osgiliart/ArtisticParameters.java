...
public class ArtisticParameters {
	...
	public static final String QUADS_PRIMITIVES = "quads";
	public static final String TRIANGLES_PRIMITIVES = "triangles";
	public static final String CIRCLES_PRIMITIVES = "circles";
