...
$turno = 0;
my $p1_turno = 0; my $p1_turnoN; my $p1_puesto = 0; my  $p1_proc = 0;
my $p2_turno = 0; my $p2_turnoN; my $p2_puesto = 0; my  $p2_proc = 0;
my $p3_turno = 0; my $p3_turnoN; my $p3_puesto = 0; my  $p3_proc = 0;
my $p4_turno = 0; my $p4_turnoN; my $p4_puesto = 0; my  $p4_proc = 0;
my $puesto = 4;
my $turno_normaliza = 0;
				...
				if(!$p1_proc){
					if($3 eq "false"){
						if($turno > 1 && $p1_turno == 0 && $3){
							$p1_turno = $turno - $turno_normaliza; $turno_normaliza = $turno;
							$p1_puesto = $puesto;
							$puesto--;
						}
					}
				...
				if(!$p2_proc){
					if($3 eq "false"){
						if($turno > 1 && $p2_turno == 0 && $3){
							$p2_turno = $turno - $turno_normaliza; $turno_normaliza = $turno;
							$p2_puesto = $puesto;
							$puesto--;
						}
					}
				...
				if(!$p3_proc){
					if($3 eq "false"){
						if($turno > 1 && $p3_turno == 0 && $3){
							$p3_turno = $turno - $turno_normaliza; $turno_normaliza = $turno;
							$p3_puesto = $puesto;
							$puesto--;
						}
					}
				...
				if(!$p4_proc){
					if($3 eq "false"){
						if($turno > 1 && $p4_turno == 0 && $3){
							$p4_turno = $turno - $turno_normaliza; $turno_normaliza = $turno;
							$p4_puesto = $puesto;
							$puesto--;
						}
					}
