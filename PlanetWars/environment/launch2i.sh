...
map=${2}
 java -jar ${folder}/PlayGame-1.2.jar 2> ${folder}/error${3}.txt ${folder}/maps/${map} 1000 1000 ${folder}/log${3}.txt "java -jar ${folder}/gpagent.jar $tree " "java -jar ${folder}/gpagent.jar $tree "
